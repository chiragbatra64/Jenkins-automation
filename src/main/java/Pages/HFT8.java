...
public class HFT8 {
	...
	private final By enableRhel8DependenciesFlag = By.xpath("//*[@id=\"ecp_CMAKE_VAR_67\"]/td/label");
	...
	public HFT8 selectReleaseVersion() {
	...
	public HFT8 enterSlimFlags() {
		...
		Waits.waitForClickable(enableRhel8DependenciesFlag).click();
		return this;
	}
	
	public HFT8 enterSlimFirstFetchFlags() {
		Waits.waitForClickable(withSlimTbtFlag).click();
	...
	public HFT8 enterFatFirstFetchFlags() {
		Waits.waitForClickable(firstFetchFlag).click();
		Waits.waitForClickable(bseLatestVersionFlag).click();
		Waits.waitForClickable(nseMultipleTraderSupportFlag).click();
		Waits.waitForClickable(enableNewRmsFlag).click();
	...
	public HFT8 enterPreOptimizedFlags() {
	...
	public HFT8 enterPreOptimizedFirstFetchFlags() {
		Waits.waitForClickable(useMtbOptFlag).click();
		Waits.waitForClickable(withPreTradeConfirmationFlag).click();
		Waits.waitForClickable(firstFetchFlag).click();
		Waits.waitForClickable(bseLatestVersionFlag).click();
	...
	public HFT8 enterFiftyDepthFlags() {
		Waits.waitForClickable(withSlimTbtFlag).click();
		Waits.waitForClickable(bseLatestVersionFlag).click();
		Waits.waitForClickable(nseMultipleTraderSupportFlag).click();
		Waits.waitForClickable(enableNewRmsFlag).click();
	...
	public HFT8 enterMOSLSlimFlags() {
		Waits.waitForClickable(withSlimTbtFlag).click();
		Waits.waitForClickable(bseLatestVersionFlag).click();
		Waits.waitForClickable(nseMultipleTraderSupportFlag).click();
		Waits.waitForClickable(enableNewRmsFlag).click();
	...
	public HFT8 pressBuild() {
		Waits.waitForClickable(buildButton).click();
		return this;
	}
	
	public HFT8 returnToDashboard() {
