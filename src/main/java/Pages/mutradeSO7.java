...
public class mutradeSO7 {
	...
	public mutradeSO7 clickBuildWithParameters() {
		Waits.waitForClickable(buildWithParameters).click();
		return this;
	}
	
	public mutradeSO7 enterBranch() {
	...
	public mutradeSO7 selectReleaseVersion() {
	...
	public mutradeSO7 selectAlgoName(String algoName) {
	...
	public mutradeSO7 selectEnableMoslFlag() {
		Waits.waitForVisible(enableMoslFlag).click();
		return this;
	}
	
	public mutradeSO7 selectJobbinhWithPrecisionFour() {
		Waits.waitForVisible(jobbingWithFourPrecisionFlag).click();
		return this;
	}
	
	public mutradeSO7 pressBuild() {
		Waits.waitForClickable(buildButton).click();
		return this;
	}
	
	public mutradeSO7 returnToDashboard() {
